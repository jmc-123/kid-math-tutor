...
基于 [withmarbleapp/os-taxonomy](https://github.com/withmarbleapp/os-taxonomy) 的数据结构 和 [text](https://github.com/Xww-coder/pep-math-taxonomy)，覆盖**义务教育教科书·数学（人民教育出版社2022版）七至九年级全6册**的完整知识图谱。
